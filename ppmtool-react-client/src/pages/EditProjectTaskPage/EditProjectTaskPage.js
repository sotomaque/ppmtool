...
import EditProjectTask from '../../components/ProjectBoard/ProjectTasks/EditProjectTask';

const useStyles = makeStyles(styles);

const EditProjectTaskPage = (props) => {
        ...
        <div className={classes.container}>
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={6}>
              <Typography variant="h2" align="center">Edit Project Task: {task_id} </Typography>
            </GridItem>
          </GridContainer>
        </div>
      </Parallax>
